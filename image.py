...
# 15
flist13 = ["김아중", "우주소녀 루다", "우주소녀 보나", "트와이스 지효", "박한별", "김새론", "황정음", "걸스데이 소진", "걸스데이 민아", "레드벨벳 슬기", "레드벨벳 웬디", "레드벨벳 예리", "미쓰에이 민", "미쓰에이 페이","러블리즈 지애", "러블리즈 예인"]
# 13
flist14 = ["임수정", "오연서", "류혜영", "조윤희", "송하윤", "천우희"]
# 13
flist15 = ["박진주", "남규리", "박소담", "하연수", "한예슬", "박하선", "김윤진", "최강희", "신소율", "심은경", "백진희", "고아성", "서우"]
# 13
flist16 = ["이영은", "한지혜", "추자현", "정은채", "한채아", "이요원", "한은정", "손은서", "김규리", "정가은", "차예련", "유인영", "서효림",
           "김소영", "연상은", "최희", "공서영", "정순주", "정인영", "장예원", "카라 강지영", "한승연", "구하라", "카라 규리"]
# 12
flist17 = ["홍수아", "김희애", "황우슬혜", "황신혜", "한고은", "윤진서", "전소민", "모델 한혜진", "배우 한혜진", "서지혜", "강혜정", "티아라 은정"]
# 12
flist18 = ["티아라 효민", "티아라 보람", "티아라 지연", "윤승아", "송은이", "한가인", "허가윤", "김현주", "엄현경",
           "이열음", "송소희", "이시영", "이하나", "달샤벳 우희", "달샤벳 수빈", "달샤벳 세리"]
# 12
flist19 = ["소율", "여자친구 신비", "여자친구 유주", "가인", "나르샤", "서인영", "박정아", "트와이스 채영", "제아", "미료",
           "나라", "여자친구 소원", "유이", "나인뮤지스 혜미", "리지", "오하영", "정화", "빅토리아", "기희현","강유미", "안소미", "채수빈"]
# 14
flist20 = ["트와이스 정연", "AOA 찬미", "마마무 문별", "마마무 솔라", "오마이걸 유아", "이수영", "박경림", "손담비", "간미연", "가수 박지윤", "박지선"]
# 12
flist21 = ["배두나", "개그맨 김지민", "김사랑", "개그맨 김영희", "개그맨 이세영", "라붐 솔빈", "라붐 유정", "장재인", "박시연", "김성은", "보아", "엠버", "다나"]
# 13
flist22 = ["씨엘", "이하이", "악동뮤지션 이수현", "이성경", "강승현", "써니힐 주비", "써니힐 승아", "차오루", "정혜성", "문지애", "김원희", "김재경", "조현영", "지숙"]
# 12
flist23 = ["이유비", "백예린", "고우리", "이선빈", "혜이니", "류화영", "최정원", "에일리", "제시", "시크릿 송지은", "시크릿 정하나", "러블리즈 베이비소울"]
# 13
flist24 = ["clc 승희", "백아연", "박지민", "원더걸스 혜림", "박보람", "조혜정", "쥬얼리 예원", "우주소녀 설아", "윤진이", "요조", "레이디 제인", "조수애", "소녀시대 수영"]
